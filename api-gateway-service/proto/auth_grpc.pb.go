...
const (
	...
	AuthService_GetMyProfile_FullMethodName    = "/auth.AuthService/GetMyProfile"
	AuthService_UpdateMyProfile_FullMethodName = "/auth.AuthService/UpdateMyProfile"
)
...
type AuthServiceClient interface {
	...
	UpdateMyProfile(ctx context.Context, in *UpdateProfileRequest, opts ...grpc.CallOption) (*UserProfile, error)
}
...
func (c *authServiceClient) RegisterUser(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
...
func (c *authServiceClient) GetMyProfile(ctx context.Context, in *GetMyProfileRequest, opts ...grpc.CallOption) (*UserProfile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserProfile)
...
func (c *authServiceClient) UpdateMyProfile(ctx context.Context, in *UpdateProfileRequest, opts ...grpc.CallOption) (*UserProfile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserProfile)
	err := c.cc.Invoke(ctx, AuthService_UpdateMyProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	UpdateMyProfile(context.Context, *UpdateProfileRequest) (*UserProfile, error)
...
func (UnimplementedAuthServiceServer) RegisterUser(context.Context, *RegisterRequest) (*AuthResponse, error) {
...
func (UnimplementedAuthServiceServer) GetMyProfile(context.Context, *GetMyProfileRequest) (*UserProfile, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMyProfile not implemented")
}
func (UnimplementedAuthServiceServer) UpdateMyProfile(context.Context, *UpdateProfileRequest) (*UserProfile, error) {
...
func _AuthService_UpdateMyProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).UpdateMyProfile(ctx, req.(*UpdateProfileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
