...
const (
	NewsService_CreateNews_FullMethodName = "/proto.NewsService/CreateNews"
	NewsService_GetNews_FullMethodName    = "/proto.NewsService/GetNews"
)
...
type NewsServiceClient interface {
	CreateNews(ctx context.Context, in *CreateNewsRequest, opts ...grpc.CallOption) (*NewsResponse, error)
	GetNews(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*NewsList, error)
}
...
func (c *newsServiceClient) CreateNews(ctx context.Context, in *CreateNewsRequest, opts ...grpc.CallOption) (*NewsResponse, error) {
...
func (c *newsServiceClient) GetNews(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*NewsList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NewsList)
...
type NewsServiceServer interface {
	CreateNews(context.Context, *CreateNewsRequest) (*NewsResponse, error)
	GetNews(context.Context, *Empty) (*NewsList, error)
...
func (UnimplementedNewsServiceServer) CreateNews(context.Context, *CreateNewsRequest) (*NewsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateNews not implemented")
}
func (UnimplementedNewsServiceServer) GetNews(context.Context, *Empty) (*NewsList, error) {
...
func _NewsService_GetNews_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NewsServiceServer).GetNews(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
