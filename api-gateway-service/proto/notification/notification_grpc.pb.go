...
const (
	...
	NotificationService_GetHistory_FullMethodName         = "/notification.NotificationService/GetHistory"
)
...
type NotificationServiceClient interface {
	Subscribe(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	Unsubscribe(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	CreateNotification(ctx context.Context, in *Notification, opts ...grpc.CallOption) (*emptypb.Empty, error)
	GetHistory(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*NotificationList, error)
}
...
func (c *notificationServiceClient) Subscribe(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *notificationServiceClient) Unsubscribe(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (c *notificationServiceClient) GetHistory(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*NotificationList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type NotificationServiceServer interface {
	Subscribe(context.Context, *EmailRequest) (*emptypb.Empty, error)
	Unsubscribe(context.Context, *EmailRequest) (*emptypb.Empty, error)
	CreateNotification(context.Context, *Notification) (*emptypb.Empty, error)
	GetHistory(context.Context, *emptypb.Empty) (*NotificationList, error)
...
func (UnimplementedNotificationServiceServer) Subscribe(context.Context, *EmailRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Subscribe not implemented")
}
func (UnimplementedNotificationServiceServer) Unsubscribe(context.Context, *EmailRequest) (*emptypb.Empty, error) {
...
func (UnimplementedNotificationServiceServer) GetHistory(context.Context, *emptypb.Empty) (*NotificationList, error) {
...
func _NotificationService_GetHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).GetHistory(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
