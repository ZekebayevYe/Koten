...
const file_proto_notification_proto_rawDesc = "" +
	"\n" +
	"\x18proto/notification.proto\x12\fnotification\x1a\x1bgoogle/protobuf/empty.proto\"R\n" +
	...
	"\x06street\x18\x05 \x01(\tR\x06street\"D\n" +
	"\x10NotificationList\x120\n" +
	"\x05items\x18\x01 \x03(\v2\x1a.notification.NotificationR\x05items2\xa9\x02\n" +
	"\x13NotificationService\x12?\n" +
	"\tSubscribe\x12\x1a.notification.EmailRequest\x1a\x16.google.protobuf.Empty\x12A\n" +
	"\vUnsubscribe\x12\x1a.notification.EmailRequest\x1a\x16.google.protobuf.Empty\x12H\n" +
	"\x12CreateNotification\x12\x1a.notification.Notification\x1a\x16.google.protobuf.Empty\x12D\n" +
	"\n" +
	"GetHistory\x12\x16.google.protobuf.Empty\x1a\x1e.notification.NotificationListB(Z&api-gateway-service/proto;notificationb\x06proto3"
...
var file_proto_notification_proto_depIdxs = []int32{
	...
	3, // 4: notification.NotificationService.GetHistory:input_type -> google.protobuf.Empty
	3, // 5: notification.NotificationService.Subscribe:output_type -> google.protobuf.Empty
	3, // 6: notification.NotificationService.Unsubscribe:output_type -> google.protobuf.Empty
	3, // 7: notification.NotificationService.CreateNotification:output_type -> google.protobuf.Empty
	2, // 8: notification.NotificationService.GetHistory:output_type -> notification.NotificationList
